/* IMPORTANT NOTE
In this file it makes no sense to make any kind of tutorial, because everyone has different slots, so here is the original without everything but aura.
What you need to keep in your mind not every necessary changes are in aura-macro.
::
* TItemPos::IsNPOS function
* TItemPos::!= operator
* NPOS variable
*/
...
#ifdef ENABLE_AURA_SYSTEM
	const DWORD c_Costume_Slot_Aura		= c_Costume_Slot_Start + 2;
