...
class Interface(object):
	...
	def RecvQuest(self, index, name):
		# QUEST_LETTER_IMAGE
		self.BINARY_RecvQuest(index, name, "file", localeInfo.GetLetterImageName(False))
	...
	def BINARY_RecvQuest(self, index, name, iconType, iconName):
		...
		if localeInfo.IsEUROPE():
			btn.SetUpVisual(localeInfo.GetLetterCloseImageName("highlight" == iconType))
			btn.SetOverVisual(localeInfo.GetLetterOpenImageName("highlight" == iconType))
			btn.SetDownVisual(localeInfo.GetLetterOpenImageName("highlight" == iconType))
		else:
